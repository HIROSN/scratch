...
(function() {
  ...
  console.log('\n// Use map function to accumulate {id, title} pairs from ' +
    'each video.');
...
(function() {
  ...
  console.log('\n// Chain the filter and map functions to select the id of ' +
    'all videos with a rating of 5.0.');
...
(function() {
  ...
  console.log('\n// Use map and concatAll to flatten the movieLists in a ' +
    'list of video ids.');
...
(function() {
  ...
  console.log('\n// Use one or more map, concatAll, and filter calls to ' +
...
(function() {
  ...
  console.log('\n// Use one or more concatMap, map, and filter calls to ' +
    'create an array with the following items');
...
(function() {
  ...
  console.log('\n// You should return an array containing only the largest ' +
    'box art.');
...
(function() {
  ...
  console.log('\n// Use one or more concatMap, map, and reduce calls to ' +
    'create an array with the following items');
...
(function() {
  ...
  console.log('\n// Retrieve each video\'s id, title, middle interesting ' +
